...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    XXXXXXX,   FN, KC_LGUI, KC_LALT,   LOWER,  KC_SPC,  KC_SPC,   RAISE, ALTRLFT, CTLRDWN,   KC_UP, KC_RGHT
),
...
[_RAISE] = LAYOUT_planck_grid(
     ...
     KC_DEL, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,    KC_4,    KC_5,    KC_6, KC_MINS,  KC_INS,
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,    KC_1,    KC_2,    KC_3, KC_PLUS, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP,  KC_END
),
